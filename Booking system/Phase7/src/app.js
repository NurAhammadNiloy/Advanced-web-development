...
import { requireAuth, requireAuthPage } from "../middleware/auth.middleware.js";
...
app.get("/resources", requireAuthPage, (req, res) => {
  res.sendFile(path.join(__dirname, 'views/resources.html'));
});

app.get("/reservations", requireAuthPage, (req, res) => {
